    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Students != null ? 
                          ...
                          Problem("Entity set 'DatabaseFirstDBContext.Students'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentName,StudentGender,Age,Standard")] Student student)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Create"] = "Student created successfully!";
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentName,StudentGender,Age,Standard")] Student student)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["Update"] = "Student created successfully!";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseFirstDBContext.Students'  is null.");
            }
            var student = await _context.Students.FindAsync(id);
            if (student != null)
            {
            ...
            await _context.SaveChangesAsync();
            TempData["Delete"] = "Student created successfully!";
            return RedirectToAction(nameof(Index));
        }
